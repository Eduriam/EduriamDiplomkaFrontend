...
% Final
Poté co kolega Bc. Jakub Vondráček dokončil implementaci příslušných koncových bodů API, jsem provedl napojení funkce na toto API. V rámci toho jsem postupoval následujícím způsobem.
