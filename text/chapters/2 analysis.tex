...
\subsubsection{FP-3 Zlepšení průběhu učení}

% write - struktura učení by se měla změnit - kombinace explanations a exercises - dříve to jen hodilo popis lekce, což není vhodné pro komplikovanější látku
% write - při učení by mělo být možné poslouchat audio, které vysvětluje danou látku, aby uživatel nemusel číst text, ale aby to bylo skutečně interaktivní (aby to celý bylo jako interaktivní video)
