...
% Write
Po identifikaci funkčních požadavků jsem dále identifikoval nefunkční požadavky. Nefunkční požadavky definují vlastnosti, které by systém měl splňovat.

% Final
Na základě předchozí analýzy jsem dále identifikoval následující nefunkční požadavky.
...
\subsubsection{NP-1 Nový design uživatelského rozhraní}
...
% Review
\subsubsection{NP-3 Zvýšení udržovatelnosti kódu}
