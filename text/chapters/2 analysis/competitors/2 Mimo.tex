...
% Final
\paragraph{Tabulky} V některých kurzech, zejména v kurzech vyučujících témata týkající se databází, jsou využívány tabulky s daty. Ty se zobrazují jednak jako součást zadání cvičení a jednak jako výstup po vyplnění daného cvičení.
...
% Final
Souhrnné hodnocení aplikace Mimo je uvedeno v tabulce \ref{table:competitor-rating-mimo}.
...
\begin{table}[ht]
    ...
    \begin{tabular}{@{} l c @{}}
        ...
        Jednoduchost učení & 8/10 \\
        Podpora opakování & 3/10 \\
        Motivace uživatelů & 7/10 \\
        Interaktivita cvičení & 7/10 \\
        \bottomrule
    \end{tabular}
    \captionsetup{justification=centering}
    \caption{Hodnocení aplikace Mimo}
    \label{table:competitor-rating-mimo}
\end{table}
