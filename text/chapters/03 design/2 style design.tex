...
% Říct, že jsem vybral stavové barvy pro indikaci varování, chyb a úspěšných stavů
% Pro chybu jsem vybral červenou, pro varování oranžovou a pro úspěch zelenou.
% Říct že jsem jako základ zvolil pastelové varianty těchto barev a od nich jsem odvodil jejich tmavší varianty. Pastelové barvy jsem volil opět za účelem snížení agresivity jednotlivých barev.
% Pro každý odstín jsem tak definoval hlavní, světlou a tmavou variantu, které bude možné využít při návrhu stavových komponentů. Pro volbu jednotlivých variant jsem opět využil nástroj Material palette generator (zde už nemusím dávat odkaz).
% V seznamu itemize pak sepsat konkrétní barvy, které jsem zvolil.
