...
% Done
\begin{tabular}{lp{0.7\linewidth}}
  \textbf{Popis:} & Uživatel se přesune na stránku s přehledem kurzů a kariérních cest. Kliknutím na kurz nebo kariérní cestu se pak přesune na jeho resp. její stránku. \\
  \textbf{Požadavek:} & \nameref{sec:fp-course-browse} \\
  \textbf{Hlavní aktér:} & Uživatel \\
  \textbf{Hlavní scénář:} & Uživatel se přesune na stránku s přehledem kurzů a kariérních cest. Aplikace mu zobrazí několik doporučených kurzů nebo kariérních cest a dále seznam všech dostupných kurzů a kariérních cest rozřazených podle kategorií. Uživatel se vybráním kurzu přesune na jeho stránku. \\
