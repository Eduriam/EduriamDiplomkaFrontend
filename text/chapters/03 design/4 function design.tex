...
\begin{tabular}{lp{0.7\linewidth}}
  ...
  \textbf{Hlavní scénář:} & Main scenario description \\
  \textbf{Alternativní scénář 1:} & Alternative scenario description \\
  \textbf{Alternativní scénář 2:} & Alternative scenario description \\
\end{tabular}
