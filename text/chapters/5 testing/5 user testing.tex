...
% Review
\paragraph{Zadání} Otevřel/a jste aplikaci a chcete se začít učit vámi zapsaný kurz. Spusťte nadcházející lekci kurzu a splňte v ní všechna cvičení. % Write - tohle jsem nakonec asi vyřadil, protože by se to na stage špatně simulovalo "Po dokončení učení spusťte opakování a opět splňte všechna cvičení."
...
\begin{enumerate}
    ...
    \item Uživatel splní všechna cvičení v rámci opakování a aplikace mu oznámí, že bylo opakování dokončeno. % Write - tento krok odstranit, pokud jsem ho nakonec nedělal
