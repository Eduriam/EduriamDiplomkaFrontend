...
% Review
V této části textu popíšu úvodní přípravu projektu a jednotlivé kroky, které jsem provedl před zahájením samotné implementace. Tuto přípravu jsem prováděl souběžně s předchozími fázemi analýzy a návrhu.
