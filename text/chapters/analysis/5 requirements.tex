...
% Write - přidat sem že Při sepisování požadavků budu také vycházet z výsledků uživatelských testů této aplikace, které jsem provedl v rámci mé bakalářské práce \cite{Jenicek2024BachelorThesis}
