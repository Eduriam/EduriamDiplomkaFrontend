...
% Review
Tato stránka učení by zároveň měla být nastavena jako výchozí stránka, na kterou bude uživatel přesměrován po spuštění aplikace. Cílem této funkce je snížit čas od zapnutí aplikace po začátek učení a dodržet tak princip "micro-interactions", který je často využíván například v aplikacích sociálních sítí. % Write - zde dát odkaz na princip z design knížky a místo sociálnch sítí uvést příklad z té knížky

% Review - zde upřesnit podle toho, na co se appka bude zaměřovat - třeba na výuku webového inženýrství
% Write - zde jsem skončil při review
\subsubsection{FP-11 Cvičení pro výuku softwarového inženýrství} 
...
% Write - ostatní aplikace mají tento aspekt velice slabý.. Proto by bylo fajn, kdyby uživatelé mohli více sdílet pokrok a achievementy s ostatními, jednoduše ostatní uživatele vyhledávat atd. V aplikaci to už trochu je, jen by to chtělo tam dát na backendu konkrétní triggers, co tam vloží tu zprávu (např achievement atd.) a na frontendu by to chtělo tam dát různé komponenty s různýma obrázkama třeba podle toho, co ten uživatel dosáhnul
...
% Write - zde napsat, že je třeba otestovat zejména základní věci v aplikaci - učení a platební systém
...
% Write - tuhle část se možná nedávat - to prostě plyne z toho že budu přidávat nové funkce a odstraňovat staré - tím se to bude přirozeně měnit
...
% Write - tenhle požadavek si nechat spíš jako hoodně optional
