...
% Done
\subsubsection{FP-11 Opakování po dokončení lekce}
...
% Done
\subsubsection{FP-12 Nová struktura učení a opakování}
...
% Done
\subsubsection{FP-13 Bloky cvičení} 
...
% Done
\subsubsection{FP-14 Editor kódu} 
...
% Done
\subsubsection{FP-15 Bloky vysvětlení látky} 
...
\begin{itemize}
    ...
    \item Seznamy číslované a nečíslované
    \item Obrázky ve formátech PNG, JPG, SVG a GIF
    \item Diagramy definované pomocí jazyka Mermaid\footnote{Dostupné na: \href{https://mermaid.js.org/}{https://mermaid.js.org/}} s animovanými přechody mezi různými kroky upravování diagramu.
    \item Ukázka kódu s animovanými přechody mezi různými kroky upravování kódu.
    \item Ukázka terminálu s animovanými přechody mezi různými kroky zadávání příkazů do terminálů a vypisování jejich výstupů.
...
% Done
\subsubsection{FP-16 Vysvětlení odpovědí ve cvičeních}
...
% Done
\subsubsection{FP-17 Nahlašování problému při učení}
...
% Done
\subsubsection{FP-18 Statistiky o učení}
