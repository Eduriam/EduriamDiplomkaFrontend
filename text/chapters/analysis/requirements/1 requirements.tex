...
% Done
\subsubsection{FP-10 Učení se podle studijního plánu}\label{sec:fp-study-plan-learning}
...
% Přidat sem audio pro jednotlivá cvičení

% Přidat sem kompletně explanation blocky
