...
% Write - zde odebrat to že chci upoutat uživatele, spíš, přidat to, že chci prostě mít úvodní stránku, kde se uživatel může rozhodnout, jestli se chce přihlásit nebo registrovat
...
\subsubsection{FP-24 Zkušební verze předplatného}
...
% Review
\subsubsection{FP-25 Přizpůsobení avatara uživatele}
...
% Review
\subsubsection{FP-26 Rozšíření obchodu a odemykání položek}
...
% Review
Vzhledem k novým požadavkům aplikace je třeba tento obchod rozšířit tak, aby bylo možné si zakoupit i položky, které jsou popsány v požadavku \hyperref[sec:fp-avatar-customization]{FP-25 Přizpůsobení avatara uživatele}.
...
% Review
\subsubsection{FP-27 Uživatelský profil}
...
% Review
\begin{itemize}
    \item Avatar uživatele, popsaný v požadavku \hyperref[sec:fp-avatar-customization]{FP-25 Přizpůsobení avatara uživatele}.
    \item Liga, ve které se uživatel nachází. Popis lig je popsán v požadavku \hyperref[sec:fp-30-leaderboard]{FP-30 Žebříček uživatelů}.
...
% Review
\subsubsection{FP-28 Zmrazení streaku}
...
% Review
\subsubsection{FP-29 Oznámení o změně stavu streaku}
...
% Review
\subsubsection{FP-30 Žebříček uživatelů}

% Review
\label{sec:fp-30-leaderboard}
...
% Review
\subsubsection{FP-31 Truhla s odměnou}

% Review
\label{sec:fp-31-treasure-chest}
...
\subsubsection{FP-32 Denní výzvy}
...
% Review
Aplikace by měla uživateli každý den zobrazit několik denních výzev, které může splnit pro získání truhly s odměnou (vizte požadavek \hyperref[sec:fp-31-treasure-chest]{FP-31 Truhla s odměnou}). Tyto výzvy mají za cíl motivovat uživatele, aby se učil nad rámec jeho základního učení, aby vyzkoušel různé funkce aplikace, a aby si rozšířil svoje znalosti napříč různými kurzy a nejen v kurzech, které má zapsané.
...
\subsubsection{FP-33 Certifikáty o dokončení kurzu}
