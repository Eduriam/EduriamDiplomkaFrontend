...
% Review
Stávající aplikace již obsahuje určité formy opakování pomocí metody spaced repetition \cite{Hlavac2024BachelorThesis}. Tuto formu opakování bude třeba změnit a přizpůsobit tak, aby bylo možné ji využít pro výuku softwarového inženýrství. Při návrhu aplikace tak bude třeba zvážit, jakým způsobem bude opakování látky v aplikaci prováděno.
