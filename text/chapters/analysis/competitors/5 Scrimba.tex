...
% Review
Platforma Scrimba obsahuje přes 80 kurzů % Write - přidat zdroj https://scrimba.com/courses
na různá témata napříč softwarovým inženýrstvím. V době psaní tohoto textu jsou kurzy zaměřeny zejména na webové technologie a umělou inteligenci. 
