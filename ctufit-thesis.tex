...
\input{text/chapters/analysis/1 introduction}

% Existing solution analysis
\input{text/chapters/analysis/existing-solution/1 existing-solution}

% Competitor analysis
\input{text/chapters/analysis/competitors/1 competitors}
\input{text/chapters/analysis/competitors/2 Mimo}
\input{text/chapters/analysis/competitors/3 Codecademy}
\input{text/chapters/analysis/competitors/4 Sololearn}
\input{text/chapters/analysis/competitors/5 Scrimba}
\input{text/chapters/analysis/competitors/6 results}

\input{text/chapters/analysis/4 gamification}
\input{text/chapters/analysis/requirements/1 requirements}

% Chapter: Design
\input{text/chapters/03 design/1 introduction}
\input{text/chapters/03 design/2 style design}
\input{text/chapters/03 design/3 prototype design}
\input{text/chapters/03 design/4 function design}

% Chapter: Implementation
\input{text/chapters/implementation/1 introduction}
\input{text/chapters/implementation/2 setup}
\input{text/chapters/implementation/3 workflow}
\input{text/chapters/implementation/4 functions}
\input{text/chapters/implementation/5 deployment}

% Chapter: Testing
\input{text/chapters/5 testing}
