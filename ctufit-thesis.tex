...
% Write - bacha, zde dát správné datum
...
% Final (Text prohlášení 1 – univerzální)
...
\input{text/chapters/1 intro/1 introduction}

% Chapter: Analysis
\input{text/chapters/2 analysis/1 introduction}

% Subchapter: Existing solution analysis
\input{text/chapters/2 analysis/existing-solution/1 existing-solution}

% Subchapter: Competitor analysis
\input{text/chapters/2 analysis/competitors/1 competitors}
\input{text/chapters/2 analysis/competitors/2 Mimo}
\input{text/chapters/2 analysis/competitors/3 Codecademy}
\input{text/chapters/2 analysis/competitors/4 Sololearn}
\input{text/chapters/2 analysis/competitors/5 Scrimba}
\input{text/chapters/2 analysis/competitors/6 results}

% Subchapter: Requirements analysis
\input{text/chapters/2 analysis/requirements/1 requirements}

% Chapter: Design
\input{text/chapters/3 design/1 introduction}
\input{text/chapters/3 design/2 function design}
\input{text/chapters/3 design/3 style design}
\input{text/chapters/3 design/4 prototype design}

% Chapter: Implementation
\input{text/chapters/4 implementation/1 introduction}
\input{text/chapters/4 implementation/2 setup}
\input{text/chapters/4 implementation/3 workflow}
\input{text/chapters/4 implementation/4 functions}
\input{text/chapters/4 implementation/5 deployment}

% Chapter: Testing
\input{text/chapters/5 testing/1 introduction}
\input{text/chapters/5 testing/2 testing options}
\input{text/chapters/5 testing/3 manual testing}
\input{text/chapters/5 testing/4 e2e testing}
\input{text/chapters/5 testing/5 user testing}
\input{text/chapters/5 testing/6 improvements}

% Chapter: Conclusion
\input{text/chapters/6 conclusion/1 conclusion}
...
\include{text/appendix/non-functional-requirements-list}
\include{text/appendix/use-case-list}
\include{text/appendix/test-results}
