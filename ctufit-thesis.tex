...
\include{text/chapters/1 introduction}
\include{text/chapters/analysis/1 introduction}

% Competitor analysis
\include{text/chapters/analysis/competitors/1 competitors}
\include{text/chapters/analysis/competitors/2 Mimo}
\include{text/chapters/analysis/competitors/3 Codecademy}
\include{text/chapters/analysis/competitors/4 Sololearn}
\include{text/chapters/analysis/competitors/5 Scrimba}
\include{text/chapters/analysis/competitors/6 results}

\include{text/chapters/analysis/2 existing solution}
\include{text/chapters/analysis/3 competitors}
\include{text/chapters/analysis/4 gamification}
\include{text/chapters/analysis/5 requirements}

% Chapter: Design
\include{text/chapters/03 design/1 introduction}
\include{text/chapters/03 design/2 ui design}
\include{text/chapters/4 implementation}
\include{text/chapters/5 testing}
\include{text/chapters/6 conclusion}
